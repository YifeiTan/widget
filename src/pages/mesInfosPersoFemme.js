...
class MesInfosPersoFemme extends Component {
    constructor(props) {
        super(props);
    ...
    state = {
        ...
        soutienGorge: cookie.load("soutienGorge"),
                ...
                <Grid>
                    <div style={{marginTop: 4 + "%", paddingLeft: 0 + "%", width: 85 + "%"}}>
                        ...
                        <Row>
                            ...
                            <Col md={4}>
                                <RadioButton name="gender" checked="checked" onClick={this.selectGendre}
                                             text="Une Femme"/>
                            </Col>
                            <Col md={4}>
                        ...
                        <Row>
                            <Col md={4}>
                                <InputText type="text" text="Prénom" unit="" save="prenom" default={this.state.prenom}
                                           onChange={this.onChange}/>
                            </Col>
                            <Col md={4}>
                                <InputText type="text" text="Adresse E-mail" unit="" save="adresseEMail"
                                           default={this.state.adresseEMail}
                                           onChange={this.onChange}/>
                            </Col>
                            <Col md={4}>
                                <InputText type="password" text="Mot de passe" unit="" save="mdp" default={this.state.mdp}
                                           onChange={this.onChange}/>
                            </Col>
                            <Col md={3}>
                                <InputText type="text" text="Soutien-gorge" unit="" save="soutienGorge" default={this.state.soutienGorge}
                                           onChange={this.onChange}/>
                            </Col>
                        </Row>
...
MesInfosPersoFemme.propTypes = {
    history: PropTypes.object.isRequired,
    closePopup: PropTypes.func,
};

export default MesInfosPersoFemme;